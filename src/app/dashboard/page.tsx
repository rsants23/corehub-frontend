...
import { dashboardStatsMock } from "@/modules/relatorios/mocks/reports.mock";
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <StatCard
          ...
          icon={Calendar}
          trend="+3,2% em relação à semana passada"
        />
      </div>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>
              ...
              {stats.patientsToday} atendimentos previstos.
            </p>
            <p>
            ...
            <p>
              {stats.suggestedReschedules} sugestões de remanejamento aguardam
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <p>• Acompanhar taxa de ocupação por terapeuta</p>
          </CardContent>
        </Card>
      </div>
    </AppShell>
